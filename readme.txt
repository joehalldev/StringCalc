...
Build script is Apache Maven.
  * After Maven is install cd to the project directroy and run "mvn install" from the command line to build with dependencies.
To run CD to the target directory contains the build.
  * java -jar StringCalc-1-jar-with-dependencies.jar "3 * 2"
